...
<section id="page-body" class="notoppadding">
    <div class="wrapper">
        ...
        <ul id="portfolio-filter" class="filter" data-related-grid="portfolio-grid">
            ...
            <li><a data-filter=".titlesp" href="#" title="titlesp">Title</a></li>
            <li><a data-filter=".goldsp" href="#" title="goldsp">Gold</a></li>
            <li><a data-filter=".silversp" href="#" title="silversp">Silver</a></li>
            <li><a data-filter=".bronzesp" href="#" title="bronzesp">Bronze</a></li>
        </ul>
    ...
    <!--Silver-->
     <div class="isotope-item portfolio-item silversp">
          <div class="portfolio-media">
            <a class="thumb-overlay overlay-effect-1 text-light">
                <img src="img/sponsors/16.jpg" alt="Dalmia">
                <div class="overlay-caption hidden-on-start">
                    <h4 class="caption-name portfolio-name uppercase">Dalmia</h4>
                </div>
            </a>
        </div>
    </div>
    ...
    <!--Bronze-->
     <div class="isotope-item portfolio-item bronzesp">
          <div class="portfolio-media">
            <a class="thumb-overlay overlay-effect-1 text-light">
    ...
    <div class="isotope-item portfolio-item bronzesp">
          <div class="portfolio-media">
            <a class="thumb-overlay overlay-effect-1 text-light">
                <img src="img/sponsors/13.jpg" alt="Dukes">
                <div class="overlay-caption hidden-on-start">
                    <h4 class="caption-name portfolio-name uppercase">Dukes</h4>
                </div>
            </a>
        </div>
    </div>
