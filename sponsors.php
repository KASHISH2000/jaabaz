...
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Galfar Almisnad</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Roots</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Toyota</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Good Year</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Fox</h4>
        </div>
    </a>
</div>
</div>
...
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Briggs & Stratton</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item platinumsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">WAM Racing</h4>
        </div>
    </a>
</div>
</div>
...
<div class="isotope-item portfolio-item goldsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Servo</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item goldsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Dinamalar</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item goldsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Magod Laser</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item goldsp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Mahashakti Energy Lt.</h4>
        </div>
    </a>
</div>
</div>
...
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Wire India Corporation</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Motilal Oswal</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Landmark Constructions</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">India Builders</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Caresoft</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">CP World</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Hovert</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Zoom Communication</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">ISC</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Expofreight</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Sibridge</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Transpek-Silox</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">BKT ATV</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Venus</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Endurance</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">GSPC</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Govt. of Jharkhand</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">Velman</h4>
        </div>
    </a>
</div>
</div>
<div class="isotope-item portfolio-item silversp">
  <div class="portfolio-media">
    <a class="thumb-overlay overlay-effect-1 text-light">
        ...
        <div class="overlay-caption hidden-on-start">
            <h4 class="caption-name portfolio-name uppercase">The Pen World</h4>
        </div>
    </a>
</div>
</div>
